                        ...
                        <div className="photo d-flex">
                            <div className="position-relative me-20">
                                ...
                                >
                                    ...
                                    >
                                        <path
                                          d="M3 6H5H21" stroke="white" strokeWidth="2" strokeLinecap="round"
                                        ...
                                        />
                                        <path
                                          d="M14 11V17" stroke="white" strokeWidth="2" strokeLinecap="round"
                                          strokeLinejoin="round"
                                        />
                                        <path
                                          d="M10 11V17" stroke="white" strokeWidth="2" strokeLinecap="round"
                                          strokeLinejoin="round"
                                        />
                                    </svg>
                                </div>
...
Full
                            ...
                            <input
                              type="text" className="form-control rounded-pill text-lg" id="name" name="name"
...
Email
                            ...
                            <input
                              type="email" className="form-control rounded-pill text-lg" id="email" name="email"
                        ...
                        <div className="pt-30">
                            ...
                            <input
                              type="tel" className="form-control rounded-pill text-lg" id="phone" name="phone"
                              aria-describedby="phone" placeholder="Enter your phone number"
                            />
                        </div>
                        <div className="button-group d-flex flex-column pt-50">
                            <button
                              type="submit" className="btn btn-save fw-medium text-lg text-white rounded-pill"
                              role="button"
                            >
Save My Profile
                            </button>
