...
<span className="fw-medium">125</span>
                                            ...
                                            <svg
                                              id="icon-check" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                              xmlns="http://www.w3.org/2000/svg"
                                            >
                                                <circle cx="10" cy="10" r="10" fill="#CDF1FF" />
                                                <path
                                                  d="M5.83301 10L8.46459 12.5L14.1663 7.5" stroke="#00BAFF"
                        ...
                        <div className="pb-md-50 pb-20">
                            ...
                            <fieldset id="paymentMethod">
                                <div className="row justify-content-between">
                                    ...
                                    >
                                        <input
                                          className="d-none" type="radio" id="transfer" name="paymentMethod"
                                          value="transfer"
                                        />
                                        <div className="detail-card">
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <svg
                                                  id="icon-check" width="20" height="20" viewBox="0 0 20 20"
...
Bank
                            ...
                            <input
                              type="text" className="form-control rounded-pill text-lg" id="bankAccount"
                        ...
                        <div className="d-sm-block d-flex flex-column w-100">
                            <a
                              href="./checkout.html" type="submit"
